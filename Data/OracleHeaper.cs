...
namespace OracleHeaper
{
    ...
    public abstract class DbHelperOra
    {
        ...
        public static string connectionString = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST='127.0.0.1')(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=orcl)));Persist Security Info=True;User ID=c#t;Password=test;";
        public DbHelperOra()
        {
        }
